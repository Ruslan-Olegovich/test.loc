...
show("Текущая версия класса: ". $w->classVersion);
...
show("Новая версия класса: " .$w->classVersion = mt_rand(2, 255));
...
show('Теперь отобразим автора класса'. $w->getAuthorName());



// ----------------------------------------------------------------------------

show("Теперь посчитаем сколько букв, в строке, которую передали классу: " . $w->strlen());
